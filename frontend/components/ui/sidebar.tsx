...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-gray-200 hidden md:block"
      data-state={state}
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-gray-700 mx-2 w-auto", className)}
      {...props}
    />
  )
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "peer-data-[active=true]/menu-button:text-gray-200 group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 md:opacity-0",
        className
      )}
      {...props}
    />
