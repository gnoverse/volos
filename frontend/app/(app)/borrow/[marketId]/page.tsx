...
export default function MarketPage() {
  ...
  return (
    <div className="container items-center justify-center py-6 space-y-6">
      <h1 className="text-2xl font-bold mb-6 text-gray-200">
        {market.loanSymbol} / {market.collateralSymbol} Market
      </h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        <Card className="bg-purple-950/80 bg-gradient-to-b from-purple-900/80 to-gray-900/50 border-none">
          <CardHeader>
